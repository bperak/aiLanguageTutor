...
def has_ai_keys() -> bool:
    # These tests hit live AI providers and can be flaky/slow.
    # Require explicit opt-in to run them even if keys are present.
    if os.getenv("RUN_LIVE_AI_TESTS") not in ("1", "true", "TRUE", "yes", "YES"):
        return False
