...
*   **Task ID**: LANG-001
    *   **Task**: Croatian Language Integration
    *   **Description**: Create Croatian language support for the lexical graph system, including graph creation from Croatian dictionary, synonym network generation, and UI integration.
    *   **Assigned to**: AI Assistant
    *   **Status**: In Progress
    *   **Date Added**: 2025-01-27
    *   **Priority**: High
    *   **Sub-tasks**:
        *   [ ] Create Croatian graph generation script from documents/rjecnik.xlsx
        *   [ ] Generate graph_models/G_synonyms_croatian.pickle with lempos as ID
        *   [ ] Create synonym network generation for Croatian
        *   [ ] Add Croatian Node information extraction
        *   [ ] Add Croatian Relation extraction
        *   [ ] Create Croatian lesson generation comparable to Japanese
        *   [ ] Update UI to support Croatian language selection
        *   [ ] Add Croatian language helper functions
        *   [ ] Create Croatian-specific tests
