...
export default function LexicalGraphSidebar({
  ...
  return (
    <div className="hidden lg:flex w-80 bg-card border border-border rounded-lg overflow-hidden">
      {/* Vertical Tabs */}
      <div className="w-16 bg-muted border-r border-border flex flex-col">
        {tabs.map((tab) => (
          <button
            key={tab.id}
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto">
                {neighbors.map((neighbor, index) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground">
                      Synonym: {neighbor.synonym_strength.toFixed(2)} | POS:{" "}
                      {neighbor.pos} | Level: {neighbor.level}
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950 p-4 rounded-lg">
                  <h4 className="font-medium text-lg mb-2">
                    Learning: {selectedNode.kanji}
                  </h4>
                  <div className="text-muted-foreground mb-3">
                    {selectedNode.hiragana} - {selectedNode.translation}
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-card p-3 rounded border border-border">
                      ...
                      <div className="text-sm text-muted-foreground mb-2">
                        // Ask questions about this word or practice using it in
                        // sentences.
                      </div>
                      <div className="space-y-2">
                        <div className="bg-muted p-2 rounded text-sm">
                          ...
                          <div>
                            Hello! I'm here to help you learn about "
                            {selectedNode.kanji}". What would you like to know?
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 px-2 py-1 text-sm border border-input bg-background text-foreground rounded"
                          />
