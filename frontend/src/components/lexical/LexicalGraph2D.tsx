    ...
    <div className="h-full w-full">
      ...
      >
        ...
        <ForceGraph2D
          ...
          linkWidth={(l: any) => Math.max(0.5, Math.min(4, (l.weight || 1) / 2))}
          linkColor={(l: any) => {
          ...
          nodeCanvasObject={(node: any, ctx: any) => {
            ...
            const size = baseSize + Math.min(3, (node.connections || 0) / 4);
            ...
            if (label) {
              const fontSize = (node.center ? 8 : 6) + Math.min(4, (node.connections || 0) / 3);
