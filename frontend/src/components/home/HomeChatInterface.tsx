...
export default function HomeChatInterface({ profileStatus }: HomeChatInterfaceProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      {/* Profile Status Widget - Prominently displayed */}
      {profileStatus && (
        <div className="mb-6">
          <ProfileStatusWidget
            profileCompleted={profileStatus.profile_completed}
            profileSkipped={profileStatus.profile_skipped}
            profileData={homeStatus?.profile_summary}
          />
        </div>
      )}
